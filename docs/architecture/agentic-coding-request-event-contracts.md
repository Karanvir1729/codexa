# Agentic Coding Request and Event Contracts
...
Creates a browser or phone-based coding assistance session and assigns a realtime voice node.

```json
{
  "developer_id": "developer_123",
  "topic": "coding",
  "client_caps": {
    "webrtc": true,
    "twilio_phone": false,
...
Plans the next low-latency assistant action. This reads only fast session state and the active promoted coding strategy.

```json
{
  "session_id": "session_123",
  "transcript_final": "I still do not get why this is not calculator bug.",
  "local_signals": {
    "barge_in": false,
    "silence_ms": 420,
    "audio_quality": "good"
...
Promotes a tested coding strategy after replay evals and regression checks pass.
...
{
  "event_id": "evt_123",
  "type": "failure_mode.detected",
  "session_id": "session_123",
  "developer_id": "developer_123",
  "source": "failure-mode-agent",
  "trace_id": "trace_abc",
  "schema_version": "2026-05-21",
  "idempotency_key": "session_123:failure_mode:calculator bug_001",
  "payload": {}
}
```
...
Only promoted strategy versions affect live coding assistance.
