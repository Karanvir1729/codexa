...
const supervisorWorkspacePath = import.meta.env.VITE_SUPERVISOR_WORKSPACE_PATH?.trim() || "";
...
function supervisorWorkspacePayload() {
  return supervisorWorkspacePath ? { workspace_path: supervisorWorkspacePath } : {};
}
  ...
  return (
    <section className="builderConsole" data-testid="voice-app-builder">
      ...
      <section className="builderRuntimeStrip">
        <div>
          <span>Workspace</span>
          <strong>{supervisorWorkspacePath || "Supervisor default"}</strong>
        </div>
        <div>
          <span>Reasoning</span>
