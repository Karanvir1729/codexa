...
const outPath = "docs/architecture/tutor-tron-feedback-state-machine.excalidraw";
const clipPath = "docs/architecture/tutor-tron-feedback-state-machine.clipboard.json";
...
// Title
els.push(text(70, 40, 780, "Tutor-Tron Voice Agent", 48, "#111827", { align: "left" }));
els.push(text(
  75,
  104,
  1640,
  "Modular production microservices architecture. Red path stays low-latency; green improvement loop is eval-gated before it reaches live tutoring.",
  24,
  "#334155",
  { align: "left" },
));
...
// User/browser icons
iconBlock(els, 95, 260, "file_browser", "React Web App", "student UI", { color: "#111827" });
...
iconBlock(els, 1265, 282, "file_orch", "Tutor Orchestrator", "live context", { labelW: 170, size: 74 });
...
label(els, 170, 292, 120, "student speaks", "#b91c1c", 14);
...
els.push(text(1510, 860, 600, "Only promoted strategy versions affect live tutoring", 23, "#15803d"));
...
const states = [
  ["Observed Failure", "pitfall + failed strategy", "file_worker", "Pitfall\nDetection Agent"],
...
iconBlock(els, 965, 1342, "file_key", "Keyspaces RF=3", "cohort + pitfalls", { labelW: 190, size: 72 });
