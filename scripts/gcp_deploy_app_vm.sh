...
REMOTE_WHISPER_INITIAL_PROMPT="${REMOTE_WHISPER_INITIAL_PROMPT:-This is a live voice agent conversation. Transcribe English, Hindi, Urdu, and Hinglish accurately. Preserve technical terms and names such as Pipecat, PipeCAD, Cekura, NVIDIA NIM, Nemotron, Mistral, Voxtral, Twilio, WebRTC, Vercel, Cloudflare, Google Cloud, Vertex AI, Whisper, STT, and TTS.}"
REMOTE_WHISPER_HOTWORDS="${REMOTE_WHISPER_HOTWORDS:-Pipecat, PipeCAD, Cekura, Daily, NVIDIA, NIM, Nemotron, Mistral, Voxtral, Whisper, Faster Whisper, Twilio, WebRTC, Vercel, Cloudflare, Google Cloud, GCP, Vertex AI, GPU, TPU, LLM, STT, TTS, Hindi, Urdu, Hinglish}"
