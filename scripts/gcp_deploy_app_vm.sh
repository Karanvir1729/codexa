...
VOICE_STT_CORRECTION_ENABLED="${VOICE_STT_CORRECTION_ENABLED:-true}"
...
REMOTE_WHISPER_INITIAL_PROMPT="${REMOTE_WHISPER_INITIAL_PROMPT:-Transcribe short live voice-agent commands exactly. Common commands include: Can you talk faster? Talk faster than that. Talk very fast. Very fast. Talk slower. Use normal speed. Preserve PipeCAD, Pipecat, Codex, WebRTC, Whisper, Voxtral, and Orchestrator.}"
REMOTE_WHISPER_HOTWORDS="${REMOTE_WHISPER_HOTWORDS:-Can you talk faster, talk faster than that, talk very fast, very fast, talk slower, normal speed, PipeCAD, Pipecat, Codex, WebRTC, Whisper, Voxtral, Orchestrator}"
