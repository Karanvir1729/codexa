...
REMOTE_WHISPER_INITIAL_PROMPT="${REMOTE_WHISPER_INITIAL_PROMPT:-Transcribe live voice-agent speech exactly. Preserve the user's wording, punctuation, product names, acronyms, and code terms. Use English unless the speaker clearly uses another language. Preserve PipeCAD, Pipecat, Codex, WebRTC, Whisper, Voxtral, Orchestrator, GitHub, repository, deploy, flowchart, and voice agent.}"
REMOTE_WHISPER_HOTWORDS="${REMOTE_WHISPER_HOTWORDS:-PipeCAD, Pipecat, Codex, WebRTC, Whisper, Voxtral, Orchestrator, GitHub, repository, deploy, flowchart, voice agent}"
