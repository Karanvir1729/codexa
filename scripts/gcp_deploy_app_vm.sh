...
LOCAL_STT_NO_SPEECH_PROB="${LOCAL_STT_NO_SPEECH_PROB:-0.35}"
LOCAL_VAD_CONFIDENCE="${LOCAL_VAD_CONFIDENCE:-0.6}"
LOCAL_VAD_START_SECS="${LOCAL_VAD_START_SECS:-0.05}"
LOCAL_VAD_STOP_SECS="${LOCAL_VAD_STOP_SECS:-0.12}"
LOCAL_VAD_MIN_VOLUME="${LOCAL_VAD_MIN_VOLUME:-0.3}"
...
LOCAL_USER_SPEECH_TIMEOUT="${LOCAL_USER_SPEECH_TIMEOUT:-0.12}"
LOCAL_USER_TURN_STOP_TIMEOUT="${LOCAL_USER_TURN_STOP_TIMEOUT:-0.4}"
...
LOCAL_TTS_PROVIDER=${LOCAL_TTS_PROVIDER:-piper}
...
VOXTRAL_TTS_VOICE=${VOXTRAL_TTS_VOICE:-vivian}
