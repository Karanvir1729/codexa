...
VOICE_BEHAVIOR_MODE="${VOICE_BEHAVIOR_MODE:-assistant}"
VOICE_FLOW_ID="${VOICE_FLOW_ID:-active}"
VOICE_STT_CORRECTION_ENABLED="${VOICE_STT_CORRECTION_ENABLED:-false}"
VOICE_EMOTION_CODES_ENABLED="${VOICE_EMOTION_CODES_ENABLED:-true}"
VOICE_CLONE_ENABLED="${VOICE_CLONE_ENABLED:-true}"
VOICE_CLONE_PLAYBACK_ENABLED="${VOICE_CLONE_PLAYBACK_ENABLED:-false}"
VOICE_CLONE_ALLOW_SELF_HOSTED_REF_AUDIO="${VOICE_CLONE_ALLOW_SELF_HOSTED_REF_AUDIO:-false}"
LLM_PROVIDER="${LLM_PROVIDER:-local}"
LOCAL_STT_PROVIDER="${LOCAL_STT_PROVIDER:-remote_whisper}"
LOCAL_STT_MODEL="${LOCAL_STT_MODEL:-large-v3-turbo}"
...
REMOTE_WHISPER_INITIAL_PROMPT="${REMOTE_WHISPER_INITIAL_PROMPT:-}"
REMOTE_WHISPER_HOTWORDS="${REMOTE_WHISPER_HOTWORDS:-}"
...
MAX_COMPLETION_TOKENS=${MAX_COMPLETION_TOKENS:-180}
...
VOICE_STT_CORRECTION_ENABLED=${VOICE_STT_CORRECTION_ENABLED}
VOICE_EMOTION_CODES_ENABLED=${VOICE_EMOTION_CODES_ENABLED}
VOICE_CLONE_ENABLED=${VOICE_CLONE_ENABLED}
VOICE_CLONE_PLAYBACK_ENABLED=${VOICE_CLONE_PLAYBACK_ENABLED}
VOICE_CLONE_ALLOW_SELF_HOSTED_REF_AUDIO=${VOICE_CLONE_ALLOW_SELF_HOSTED_REF_AUDIO}
LOCAL_VOICE_LANGUAGE=${LOCAL_VOICE_LANGUAGE:-en}
LOCAL_STT_PROVIDER=${LOCAL_STT_PROVIDER}
...
VOXTRAL_TTS_INSTRUCTIONS=${VOXTRAL_TTS_INSTRUCTIONS:-Speak naturally, warmly, and quickly. Match the user's language when possible. Keep emotional tone calm and helpful unless the text clearly asks for a different tone.}
VOXTRAL_TTS_REF_AUDIO_PATH=${VOXTRAL_TTS_REF_AUDIO_PATH:-}
VOXTRAL_TTS_REF_AUDIO_ENABLED=${VOXTRAL_TTS_REF_AUDIO_ENABLED:-false}
VOXTRAL_TTS_REF_AUDIO_FORMAT=${VOXTRAL_TTS_REF_AUDIO_FORMAT:-auto}
VOXTRAL_TTS_RESPONSE_FORMAT=${VOXTRAL_TTS_RESPONSE_FORMAT:-pcm}
VOXTRAL_TTS_STREAM=${VOXTRAL_TTS_STREAM:-true}
VOXTRAL_TTS_PCM_ENCODING=${VOXTRAL_TTS_PCM_ENCODING:-int16}
VOXTRAL_TTS_SPEED=${VOXTRAL_TTS_SPEED:-1.0}
